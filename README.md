...
star_aligner.sh - a bash script to align the paired fastq reads to the GENCODE Human reference genome using STAR and output unsorted bam files
...
The importing of the counted reads to be analyzed with DEXSEQ by testing for differential exon usage
...
Whole Genome Network Correlation Analysis (WGCNA) to generate gene network associations for visualization with Cytoscape
